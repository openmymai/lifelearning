        ...
        <div className="container d-flex align-items-center">
          <nav id="navbar" ref={ref} className={`${navbarOpen && size.width < 992 ? 'navbar navbar-mobile' : 'navbar'}`}>
            <ul>
              ...
              <li><a onClick={() => setNavbarOpen((prev) => !prev)} className="nav-link" href="/#primary">บทวิปัสสนาภาวนา</a></li>
              <li><a onClick={() => setNavbarOpen((prev) => !prev)} className="nav-link" href="/#services">หลักสูตรอนาคามีผล</a></li>
              <li><a onClick={() => setNavbarOpen((prev) => !prev)} className="nav-link" href="/#additional">บทวิปัสสนาภาวนาเพิ่มเติม</a></li>
